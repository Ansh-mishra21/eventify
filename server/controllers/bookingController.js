...
// User books an event (initial booking request, pending confirmation)
...
// Admin confirms booking and reduces seat count
...
// Get all bookings for the logged-in user (or all bookings for admin)
...
// Get booking details by ID (for ticket page)
